...
warndlg('This implementation using the central slice theorem is very susceptable to discretaization effects.');
...
for i = 1:numOfAngularProjections
    ...
    % on the fly visualization in fourier domain
    imagesc(real(BPI_fourier))
